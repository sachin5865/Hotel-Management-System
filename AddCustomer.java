...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        JLabel text = new JLabel("NEW CUSTOMEER FORM");
        ...
        try{
            Conn conn = new Conn();
            String query = "select * from room where availability = 'Avaolable'";
        ...
        lblcheckintime.setFont(new Font("Railway", Font.PLAIN, 16));
        add(lblcheckintime);
